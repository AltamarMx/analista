...
Si ya sabes Python, tienes los conocimientos básicos de Pandas y Matplotlib, estás listo para pasar al siguiente nivel en el mundo de la `programación y análisis de datos`, ¡estás en el lugar correcto!. En este curso [MOOC Python: de explorador de datos a analista](https://www.coursera.org/learn/pythonanalista/home/welcome) vamos a transformarte de explorador de datos a analista. 
